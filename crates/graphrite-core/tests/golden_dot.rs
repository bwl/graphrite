...
fn assert_dot_contains(path: &str, needles: &[&str]) {
    ...
    for n in needles { assert!(out.contains(n), "missing: {}", n); }
}

#[test]
fn bluesky_golden_dot_stable() {
    assert_dot_contains("/Users/bwl/Developer/aiaide/samples/valid/bluesky.mmd", &[
        "digraph G",
...
fn simple_flow_golden_dot() {
    assert_dot_contains("/Users/bwl/Developer/aiaide/samples/valid/simple_flow.mmd", &[
        "start [label=\"Start\"];",
...
fn very_parallel_golden_dot() {
    assert_dot_contains("/Users/bwl/Developer/aiaide/samples/valid/very_parallel.mmd", &[
        "ingest [label=\"Ingest\"];",
...
fn maintenance_loop_golden_dot() {
    assert_dot_contains("/Users/bwl/Developer/aiaide/samples/valid/maintenance_loop.mmd", &[
...
fn thought_pattern_golden_dot() {
    assert_dot_contains("/Users/bwl/Developer/aiaide/samples/valid/thought_pattern.mmd", &[
...
fn us_highway_system_golden_dot() {
    assert_dot_contains("/Users/bwl/Developer/aiaide/samples/valid/us_highway_system.mmd", &[
        "nyc [label=\"New York\"];",
        "bos [label=\"Boston\"];",
